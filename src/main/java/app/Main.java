...
public class Main
{
    public static void main(String[] args)
    {
        ...
        String response4 = apiReader.getDataFromClientWithRating("https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&vote_average.gte=%%&vote_average.lte=##&api_key="+api_key, lowerRating, upperRating);
